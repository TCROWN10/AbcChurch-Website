    ...
    <div className="min-h-screen flex flex-col bg-[#0C232B]">
      ...
      <div className="relative w-full h-[320px] md:h-[400px] flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-2xl md:text-4xl font-bold text-white drop-shadow mb-2">CONNECTLife Daily Devotional</h1>
          <h2 className="text-xl md:text-2xl font-bold text-[#FF602E] drop-shadow mb-1">Building Godly Character</h2>
          <div className="text-base md:text-lg text-[#FFDECC] drop-shadow">{today}</div>
        </div>
      </div>
      {/* Devotional Content */}
      <div className="max-w-4xl w-full mx-auto text-white rounded-b-lg px-6 md:px-12 py-8 mt-0 z-10 relative" style={{ backgroundColor: '#0C252E' }}>
        <div className="mb-4">
          <span className="font-semibold text-[#FF602E]">Memory Verse :</span> Proverbs 11:3 | ESV<br/>
          <span className="text-sm">The integrity of the upright guides them, but the crookedness of the treacherous destroys them.</span>
        </div>
        <div className="mb-4">
          <span className="font-semibold text-[#FF602E]">Bible Reading :</span> Titus 2:7 - 8 | AMPC<br/>
          <span className="text-sm">7 And show your own self in all respects to be a pattern and a model of good deeds and works, teaching what is unadulterated, showing gravity [having the strictest regard for truth and purity of motive], with dignity and seriousness.<br/>
        ...
        <div className="mb-6">
          <h3 className="font-bold text-lg mb-2 text-[#FF602E]">Message</h3>
          <p className="mb-2">A godly character is beneficial not only for eternal purposes but also for our lives here on earth.<br/>
          ...
          <h4 className="font-semibold mt-4 mb-1">1. Godly And Consistent Devotional Life.</h4>
          <p className="mb-2">Maintaining your relationship with God through a consistent devotional life is key.<br/>
          ...
          <p className="mb-2">These “fruit” are all attributes of the character of Christ. Produced in us by yielding completely to the leading of the Holy Spirit.<br/>
          “…If you remain in Me and I in you, you will bear much fruit…”<br/>
          “if you remain in Me and My words remain in you…”</p>
          <p className="mb-2">By simply maintaining a consistent devotional life. The very life and character of God will in many ways almost “automatically” be transferred to you.<br/>
          ...
          <h4 className="font-semibold mt-4 mb-1">2. Godly Choices And Decisions.</h4>
          <p className="mb-2">Making the right choices, again and again, builds godly character into our lives. God has given us a will- the ability to choose and to choose righteousness.<br/>
          ...
          <h4 className="font-semibold mt-4 mb-1">3. Godly Mentoring And Discipleship</h4>
          <p className="mb-2">Apart from the Word of God, and your relationship with Him, the single most important factor in a Christian life, would be godly mentoring. The Bible says in Proverbs 13:20,<br/>
          He who walks with wise men will be wise, But the companion of fools will suffer harm.</p>
          <p className="mb-2">Have you ever thought on how much your relationship with your friends influences you? It is surprisingly more than one can imagine.<br/>
          ...
          <p className="mb-2">It is the will of God for us to live godly in Christ Jesus. If you truly love God, you will want to honor Him. You will want to represent Him well. Knowing that a godly lifestyle brings glory and honor to the Lord.</p>
          <p className="italic text-xs mb-4">( Coined from "Three Keys to Building Godly Character" by Bishop Rich Conte)</p>
          <h4 className="font-semibold mt-4 mb-1">Prayer points</h4>
          <ul className="list-disc list-inside ml-6 mb-2">
          ...
          <h4 className="font-semibold mt-4 mb-1">Quotes</h4>
          <ul className="list-disc list-inside ml-6 mb-2">
          ...
          <div className="mt-4">
            <span className="font-semibold text-[#FF602E]">BIBLE IN ONE YEAR</span><br/>
            Ezekiel 21 - 30
          </div>
        </div>
      </div>
