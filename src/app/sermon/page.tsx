    ...
    <div className="min-h-screen flex flex-col bg-[#0C232B]">
      ...
      <div className="relative w-full h-[320px] md:h-[400px] flex items-center justify-center">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-2xl md:text-4xl font-bold text-white drop-shadow mb-2">Sermon</h1>
          <h2 className="text-xl md:text-2xl font-bold text-[#FF602E] drop-shadow mb-1">God is Good</h2>
