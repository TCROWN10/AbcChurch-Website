      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12 relative z-10">
        ...
        >
          ...
          <div className="flex flex-col gap-4 sm:gap-6 w-full max-w-md">
            {/* Card 1 */}
            <motion.div 
              className="flex items-start gap-3 sm:gap-4 bg-[#425A60] rounded-lg shadow-lg p-4 sm:p-6 w-full"
        ...
        >
          <motion.div 
            className="rounded-2xl overflow-hidden shadow-lg w-full max-w-xs sm:w-[220px] sm:h-[200px] md:w-[420px] md:h-[380px] h-[180px] bg-[#fff] flex items-center justify-center"
