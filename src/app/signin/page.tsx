  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
      ...
      <button
        ...
        onKeyDown={(e) => {
          if (e.key === 'Enter') {
            console.log('Back icon enter key');
            if (window.history.length > 1) {
              router.back();
            } else {
              router.push('/');
      ...
      <div className="flex-1 flex items-center justify-center relative z-20 px-4 md:px-0">
        ...
        >
          ...
          {/* Form */}
          <form className="w-full px-3 md:px-6 pt-4 md:pt-6 flex flex-col gap-2 md:gap-3">
            <AnimatePresence mode="wait">
              {activeTab === "create" && (
                ...
                >
                  ...
                  <motion.button
                    type="submit"
                    className="w-full mt-2 bg-[#FF602E] text-white py-2 rounded font-semibold text-sm transition hover:opacity-90 cursor-pointer"
                  ...
                  <motion.button
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 py-2 px-3 rounded font-medium text-sm transition hover:bg-gray-50 cursor-pointer"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
              ...
              {activeTab === "signin" && (
                ...
                >
                  ...
                  <motion.button
                    type="button"
                    className="w-full mt-1 bg-[#FF602E] text-white py-2 rounded font-semibold text-sm transition hover:opacity-90 cursor-pointer"
                    whileHover={{ scale: 1.02 }}
                    whileTap={{ scale: 0.98 }}
