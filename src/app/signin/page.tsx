  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden">
      ...
      <button
        ...
        className="absolute top-28 left-8 z-50 flex items-center justify-center w-12 h-12 bg-transparent hover:bg-white/20 rounded-full transition-all duration-200 cursor-pointer"
      ...
      >
        {/* Chevron Left SVG */}
        <svg width="28" height="28" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2.5" className="text-gray-800">
      ...
      <div className="flex-1 flex items-center justify-center relative z-20">
        ...
        {/* Card */}
        <motion.div
          className="w-full max-w-sm min-w-[320px] bg-[#FFFFFF] rounded shadow-md px-4 pt-6 pb-8 flex flex-col items-center relative"
